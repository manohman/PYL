...
namespace PYL.ViewModel {
    ...
    public class MainViewModel : ViewModelBase {
        ...
        public MainViewModel(IDataService dataService, ISquareSelectorService squareSelectorService) {
            ...
            this.SelectSquareCommand = new RelayCommand(this.SelectSquare); // Command + Player.CommandKey
            this.StartNewGameCommand = new RelayCommand(this.StartNewGame); // Alt + Enter
